...
ja $h$ on homeomorfismi $X\rightarrow h(X)\subset\hat{X}$, jossa $h(X)$ on tiheä avaruudessa $\hat{X}$. 
\end{maar}
\begin{huom}
...
ja $(\beta X,\rho)$ avaruuden $X$ Stone-Čech kompaktisointi. 
%3
$\beta X$ on laajin kompaktisointi avaruudelle $X$: Jos $\hat{X}$ on avaruuden $X$ kompaktisointi, niin $\hat{X}$ on avaruuden $\beta X$ tekijäavaruus, eli $\hat{X}$ on homeomorfinen $\beta X / K(F)$ kanssa jollain $K(F)$.
\begin{proof}
