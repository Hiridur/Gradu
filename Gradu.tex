...
Näin ollen $H(\overline{\rho(X)}\subset\overline{\rho_1(Y)}$ 
...
\end{maar}
\begin{huom}
Usein samaistetaan avaruus $X$ ja $h(X)\subset\hat{X}$ ja sanotaan, 
...
\begin{lause}
Olkoon $X$ täysin säännöllinen avaruus 
ja $\beta X$ avaruuden $X$ Stone-Čech kompaktisointi. 
