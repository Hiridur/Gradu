...
%Tällöin on olemassa kaavalla $\rho(x)=\prod_{f\in I^X}(f(x)),x\in X $ määritelty upotus $\rho\colon X\rightarrow P^X$. 
...
$P_f\circ\rho(x)=f(x),x\in X,f\in I^X$ yhdisteenä jatkuva.
