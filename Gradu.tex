...
\begin{proof}
Korollaari on suora seuraus määritelmästä \ref{uniformisti_jatkuva} ja uniformisuuden määritelmän \ref{uniformi_maar} ehdosta \ref{F_I}.
\end{proof}
\end{kor}
\begin{lause}
...
\begin{proof}
Olkoot $X$, $X'$ ja $X''$ uniformeja avaruuksia, 
$f\colon X\rightarrow X'$ ja $g\colon X'\rightarrow X''$ uniformisti jatkuvia kuvauksia ja 
...
Nyt 
$$B=\{g_{H}^\leftarrow ([0,a])\subset X\times X\mid H\subset I \text{ äärellinen}, a\in\R_+ \}$$
