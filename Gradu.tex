...
uniformiteettiperheen $(\U_{f_i})_{i\in I} $ pienin yläraja, 
...
$$B_g=\left\{g^\leftarrow[0,a]\subset X\times X\mid a\in\R_+\right\}
=\left\{\bigcap_{i\in I} f_i^\leftarrow[0,a]\subset X\times X\mid a\in\R_+\right\}.$$
Nyt $B_f\subset B_g$, sillä  $ f_i^\leftarrow[0,a]\in\U_{f_i}$, kun $i\in I$ ja $a\in [0,\infty]$.
