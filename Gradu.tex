...
\begin{maar}
Topologinen avaruus on \emph{säännöllinen}, jos jokaisella pisteellä ja jokaisella suljetulla joukolla on erilliset ympäristöt.
\end{maar}
...
\begin{lause}
Täysin säännöllisen topologisen avaruuden aliavaruus on täysin säännöllinen.
\begin{proof}
...
\begin{lause}
Olkoon $X$ täysin säännöllinen topologinen avaruus. 
...
Tällöin on olemassa kaavalla $\rho(x)=\prod_{f\in I^X}(f(x)),x\in X $ määritelty homeomorfismi $\rho\colon X\rightarrow \rho X\subset P^X$. 
...
\begin{proof}
Olkoon $X$ täysin säännöllinen topologinen avaruus ja 
$\rho\colon X\rightarrow \rho X\subset P^X$ kuvaus, 
...
$$\rho V_{f_0}=\left\{\prod_{f\in I^X}\mid t_f\in I \text{ kaikilla }f\in I^X, t_{f_0}<1\right\}\cap \rho X$$
