...
ja voidaan valita $U'= U^{-1}$, jolloin erityisesti $U'\subset U^{-1}$.
%
...
seuraa epäyhtälö $|f(x,z)-f(z,y)|\leq f(x,y)$, kun $x,y,z\in X$.
\end{huom}
\begin{esim}%1
...
$a\in\,]0,\infty]$ on olemassa sellainen $b\in\,]0,\infty]$, 
jolla pätee $f(x,y)\leq a$, jos $g(x,y)\leq b$ kaikilla $x,y\in X$.

Jos lisäksi jokaiselle $a\in\,]0,\infty]$ on olemassa $b\in\,]0,\infty]$, jolla pätee $g(x,y)\leq a$, jos $f(x,y)\leq b$ kaikilla $x,y\in X$, niin $f$ ja $g$ ovat ekvivalentteja pseudometriikoita.
\begin{proof}
