...
ja $(\beta X,\rho)$ avaruuden $X$ Stone-Čech kompaktisointi. 
%3
$\beta X$ on laajin kompaktisointi avaruudelle $X$: 
Jos $\hat{X}$ on avaruuden $X$ kompaktisointi, 
niin $\hat{X}$ on avaruuden $\beta X$ tekijäavaruus. 
Kompaktisointi $\hat{X}$ on homeomorfinen tekijäavaruuden $\beta X / \sim$ kanssa, 
kun $\sim$ on ekvivalenssirelaatio $a\sim a'$, kun $F(a)=F(a')$, $a,a'\in \beta X$.
\begin{proof}
