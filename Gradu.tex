...
Tässä luvussa perehdytään uniformisoituviin avaruuksiin (uniformizable space). 
\begin{maar}
%Olkoon $X$ topologinen avaruus.
Topologinen avaruus $(X,\T)$ on \emph{uniformisoituva}, jos seuraava 
ominaisuus pätee:
\begin{enumerate} [label=(Z1),ref=(Z1)]
\item Kaikille alkioilla $x_0\in X$ ja kaikille 
