...
eli on olemassa 
%kaavalla $\rho(x)=\prod_{f\in I^X}(f(x)),x\in X $ määritelty 
homeomorfismi $\rho\colon X\rightarrow \rho X\subset P^X$. 
...
joka on määritelty kaavalla $\rho(x)=\{f(x)\}$ kaikilla $x\in X $. 
...
$$H\left(\prod_{f\in I^X}\{t_f\}\right)=\left(h_g\left(\prod_{f\in I^X}\{t_f\}\right)\right)_{g\in I^Y},t\in I$$ 
voidaan muodostaa jatkuva kuvaus $H\colon P^X\rightarrow P^Y$. 
Nyt 
$$(H\circ \rho)(x)=H(\{f(x)\})=\{h_g(\{f(x)\})\}=\{(g\circ h)(x)\}=(g(h(x)))_{g\in I^Y}.$$
