...
\end{lause}
\begin{lause}
Yleistetään nyt edellistä lausetta. 
Olkoon $X$ joukko, $f$ pseudomeriikka joukolle $X$, $a\in\R_+$ reaaliluku ja 
$\U_a\subset X\times X$ joukko kaavalla $\U_a=f^{\rightarrow}[0,a]$. Tällöin kokoelma $B=\{ \U_a\mid a\in\R_+\}$ on uniformisuuden kanta joukolle $X$.
\begin{proof}
