...
$(P_f\circ\rho)(x)
%=P_f(\rho(x))
=f(x)$ kaikilla $x\in X$ ja $f\in I^X$ ovat jatkuvia, joten myös kuvaus $\rho$ on jatkuva \cite[lause~7.10]{Topo2}. 
...
Kuvajoukko $F(\beta X)$ on suljettu ja  
%joka 
sisältää joukossa $\hat{X}$ tiheän osajoukon $X$, 
%Näin ollen 
