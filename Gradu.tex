...
Kuvaus $f$ on tasaisesti jatkuva (uniformiteetin $\U_0$ suhteen), 
...
avaruus $(X,\U)$ on täydellinen. 
%TODO siirrettävä uniformisoituva ja täydellinen luvut keskenään?
\end{lause}
%
%
...
\begin{maar}
Topologinen avaruus on \emph{täydennetysti säännöllinen} (completely regular), 
